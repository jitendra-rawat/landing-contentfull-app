...
export const metadata: Metadata = {
  title: 'Landing Page 2 - Contentful + Next.js',
  description: 'Dynamic landing page built with Contentful CMS',
};

async function getPageData() {
  try {
    const pageData = await contentfulClient.getLandingPage('page-2');
    return pageData;
  } catch (error) {
        ...
        {pageData ? (
          ...
          <div className="container">
            <div className="error-state">
              ...
              <ul>
                <li>Created a page entry in Contentful with slug &quot;page-2&quot;</li>
